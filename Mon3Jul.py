...
if plant == "Spathiphyllum":
    print("Yes - Spathiphyllum is the best plant ever!")    # if spelt upper case S
elif plant == "spathiphyllum":
    print("No, I want a BIG Spathiphyllum!")			# and if spelt lower case s
else:
...
# jury calculation
if jury == "y" or jury == "Y":
    tax = tax / 2                                # Divide tax by two if y/Y inputted

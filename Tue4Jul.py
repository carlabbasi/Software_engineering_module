...
"""
+================================+     ^               
| Welcome to my game, muggle!    |    /_\\
| Enter an integer number        |     O  |
...
guess_lst = []                                                  # empty list of guesses
guess = int(input("Enter your guess: "))                        # number guess prompt
...
while guess != 777:                                             # while guess is not secret number enter loop
    ...
    if guess == 7:                                              # if guess is 7 say that's the right first number
        print("That's the correct first number! Keep guessing")
        guess = int(input("Enter your guess: "))

    elif guess == 77:                                           # if guess is 77 say that's the right first two numbers
        print("That's the correct first two numbers! Keep guessing")
        guess = int(input("Enter your guess: "))

    elif "7" in str(guess):                                      # if "7" appears in guess, say a number is correct
...
for count in range(1, 6):                           # for loop, ranging through 1-5
        dot = "."                                   # define dot as "."
        dots = count * dot                          # for each iteration the count increases the amount of "."
        print(f"{count} Mississippi{dots}")         # output to screen count increments with increasing number of dots
